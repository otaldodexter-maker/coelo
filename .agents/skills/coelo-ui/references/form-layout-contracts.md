...
- Single-select reutiliza `CoeloAdminSingleSelectField`, abre na largura exata
  do campo e não usa check ou checkbox redundante.
...
- Em confirmação binária simétrica, como sair sem salvar versus continuar
  editando, as duas ações dividem igualmente a largura útil, com gap
  `CoeloSpacing.space3`.
