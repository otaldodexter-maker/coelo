...
Pronome de tratamento é contextual, curto e opcional. Para responsáveis,
catálogo como Senhor, Senhora, Dona, Seu e Doutor; para profissionais,
Professor, Instrutor, Diretor, Coordenador e Supervisor. O valor deve ficar no
perfil do vínculo/contexto, permitindo que uma pessoa híbrida tenha “Senhora”
no contexto familiar e “Professora” no contexto profissional.
...
seleção e filtragem, não autorização automática. Devem possuir owner,
instituição/unidade, membros explícitos, visibilidade e auditoria; nunca
expor crianças ou familiares de outro relacionamento por inferência. O usuário
