-- Agora: transicao material de expiracao, action_id agora.expire (historica
-- 20260909211000_now_publication_expiry_transition_v1, recarimbada; ausente em
-- producao, 0/4). Corpo fiel ao original. Depende de 20260910190400.
-- O agendador (pg_cron ou worker) continua fora deste pacote e e do coordenador.
