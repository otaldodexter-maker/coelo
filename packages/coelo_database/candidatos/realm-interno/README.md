...
| 2 | `20260912140546_forms_question_media_draft_bridge_v1.sql` | primeira ponte de `question-image`; preservada sem mutação porque já foi consumida pelo espelho | `forms_question_media_r2_v1_test.sql` 32 no primeiro ciclo | produção lote 57, em unidade com 140547..140549 |
