...
// Capture the deployed handler without opening a server or contacting providers.
...
Deno.test("preflight permits the Supabase client headers only for allowed origins", async () => {
  const key = "MOMENTS_MEDIA_ALLOWED_ORIGINS";
