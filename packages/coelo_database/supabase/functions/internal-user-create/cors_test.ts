...
Deno.test("o redirect da definicao de senha usa somente a origem HTTPS autorizavel", () => {
  assertEquals(passwordSetupRedirect("https://superadmin.coelo.me"), "https://superadmin.coelo.me/reset-password");
  assertEquals(passwordSetupRedirect("http://localhost:3000"), null);
  assertEquals(passwordSetupRedirect("https://operator:secret@superadmin.coelo.me"), null);
});
