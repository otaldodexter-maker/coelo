...
-- Prova do candidato 20260910171900_child_safety_decision_enum_cast_fix_v1 (so o cast do enum; fixtures reaproveitadas do teste do 171800).
...
-- Revisor exato da unidade decide o pedido 2: com o cast, a decisao persiste.
