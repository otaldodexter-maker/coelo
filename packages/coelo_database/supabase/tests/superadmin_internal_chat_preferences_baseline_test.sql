-- Prova do pacote 20260910240300: fixar conversa e bandeira de cor, por
-- identidade interna, devolvidos pela inbox v2 (sobre a baseline; AAL1).
begin;
...
select ok(
  ...
  and not has_function_privilege('public',
    'public.superadmin_chat_set_flag_v2(uuid,text)', 'execute'),
