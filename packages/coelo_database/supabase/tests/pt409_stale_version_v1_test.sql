...
insert into pt409_props values
  ...
  ('public.close_circular_responses(uuid,uuid,bigint)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.delete_circular(uuid,uuid,bigint)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.publish_circular(uuid,uuid,bigint,timestamp with time zone)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.publish_happens_post(uuid,uuid,bigint,timestamp with time zone)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.publish_moment(uuid,uuid,bigint)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.publish_now(uuid,uuid,bigint,timestamp with time zone)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.publish_profile_about(text,uuid,bigint,uuid)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.remove_now_publication(uuid,uuid,bigint,text)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.save_circular_draft(uuid,jsonb,uuid,bigint)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.save_circular_response_draft(uuid,uuid,jsonb,bigint)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.save_happens_draft(uuid,jsonb,uuid,bigint)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.save_moments_draft(uuid,jsonb,uuid,bigint)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.save_now_draft(uuid,jsonb,uuid,bigint)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.save_profile_about(text,uuid,jsonb,bigint,uuid,jsonb)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.submit_circular_response(uuid,uuid,bigint)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.superadmin_activity_location_create_v2(uuid,uuid,jsonb,jsonb)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.superadmin_activity_publish_v2(uuid,uuid,bigint)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.superadmin_activity_save_v2(uuid,uuid,bigint,boolean,jsonb)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.superadmin_activity_set_groups_v2(uuid,uuid,bigint,uuid[],jsonb)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.superadmin_activity_set_participants_v2(uuid,uuid,bigint,jsonb)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.superadmin_activity_set_permissions_v2(uuid,uuid,bigint,jsonb,jsonb,jsonb)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.superadmin_activity_set_professionals_v2(uuid,uuid,bigint,jsonb)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.superadmin_activity_set_units_v2(uuid,uuid,bigint,uuid[])',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.superadmin_activity_update_v2(uuid,uuid,bigint,jsonb)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.superadmin_agenda_command(uuid,uuid,bigint,text,text)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.superadmin_agenda_save(uuid,uuid,bigint,jsonb,text,boolean)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.superadmin_child_context_directory_v2(uuid,text,uuid,integer)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.superadmin_circular_close_v2(uuid,uuid,bigint)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.superadmin_circular_delete_v2(uuid,uuid,bigint)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.superadmin_circular_publish_v2(uuid,uuid,bigint,timestamp with time zone)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.superadmin_circular_save_draft_v2(uuid,uuid,uuid,uuid,uuid,jsonb)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.superadmin_group_location_create_v2(uuid,uuid,jsonb,jsonb)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.superadmin_institution_contacts_edit_v1(uuid,uuid,bigint,jsonb)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.superadmin_institution_edit_core_v2(uuid,uuid,bigint,jsonb)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.superadmin_internal_user_change_status(uuid,uuid,bigint,text,text)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.superadmin_internal_user_update(uuid,uuid,bigint,text,jsonb)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.superadmin_invite_issue_v2(uuid,uuid,uuid,uuid,uuid,uuid,text,text[],integer)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.superadmin_invite_resend_v2(uuid,uuid,bigint)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.superadmin_invite_revoke_v2(uuid,uuid,bigint,text)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.superadmin_location_copy_v2(uuid,text,uuid,uuid,text,uuid)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.superadmin_location_create_v2(jsonb,uuid)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.superadmin_location_schedule_set_v2(uuid,jsonb,bigint,uuid)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.superadmin_location_set_status_v2(uuid,text,bigint,uuid)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.superadmin_location_update_v2(uuid,jsonb,bigint,uuid)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.superadmin_notice_change_status_v2(uuid,uuid,bigint,text,text)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.superadmin_notice_publish_v2(uuid,uuid,bigint)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.superadmin_notice_save_draft_v2(uuid,uuid,bigint,jsonb)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.superadmin_plan_save(uuid,uuid,bigint,jsonb,text)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.superadmin_structure_handle_set_v1(uuid,text,uuid,bigint,text)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.superadmin_support_reply(uuid,uuid,text,bigint)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.superadmin_support_set_assignee(uuid,uuid,bigint,uuid)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.superadmin_support_set_status(uuid,uuid,text,bigint)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.withdraw_happens_post(uuid,uuid,bigint,text)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb'),
  ('public.withdraw_moment(uuid,uuid,bigint,text)',true,'search_path=""','{postgres=X/postgres,anon=X/postgres,authenticated=X/postgres,service_role=X/postgres}','postgres','v','jsonb');
