-- LOCAL ONLY: exercise package over Auth45 with production label constraints.
alter table public.platform_permissions alter column module_label drop default;
alter table public.platform_permissions alter column screen_label drop default;
alter table public.platform_permissions alter column action_label drop default;
alter table public.institution_permissions alter column module_label drop default;
alter table public.institution_permissions alter column screen_label drop default;
alter table public.institution_permissions alter column action_label drop default;
-- AP-MODELS-NOMINAL-20260909-v1: candidate; no remote authorization.
begin;
...
-- SOURCE: 20260901170731_access_profile_models_crud_and_catalog.sql
...
-- SOURCE: 20260901193000_name_access_profile_model_rpc_arguments.sql
...
-- SOURCE: 20260908021821_access_profile_models_read_prelookup_authorization.sql
...
-- SOURCE: 20260908182839_access_profile_models_aal1_phase_policy.sql
...
-- SOURCE: 20260909174500_d04_access_models_scope_filter.sql
