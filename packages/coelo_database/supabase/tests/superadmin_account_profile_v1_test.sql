...
select row_security_active('public.account_email_change_requests'::regclass, 'email requests RLS is active');
select row_security_active('public.account_profile_command_receipts'::regclass, 'account receipts RLS is active');
