...
Após gate central, Locais50 parou na candidata31000 com SQLSTATE42601 antes de qualquer pgTAP; evidência [loc50-parser-red-2026-09-08.md](../../docs/reviews/evidence/etapa-2/engenheiro-1/loc50-parser-red-2026-09-08.md). Agenda53 aplicou integralmente: catálogo10 PASS e contrato114 TAP com21 PASS/93 FAIL pela ausência dos três readers, sem aborto. Cleanup de ambas as identidades confirmado. A evidência [ag53-read-contract-red-2026-09-08.md](../../docs/reviews/evidence/etapa-2/engenheiro-1/ag53-read-contract-red-2026-09-08.md) distingue prova do CLI de uma consulta independente do ledger, que não foi realizada. Repetições com candidata alterada exigem novo pacote nominal.

O perfil **AgendaReadContractGreen** preserva a base53 e acrescenta somente a candidata20260908045531:54 entradas, target45531. O novo opt-in **RunA01LocalRuntime**, junto de **A01ClientRoot**, é exclusivo de A01DirectoryAuditGreen55/target222911; valida helper/seed/cliente antes do mutex e chama o helper após reset dentro do cleanup existente. Rejeita TestPath/RunLint e os outros modos nessa janela. A preparação A01 inclui44 testes do helper,31 da integração e smoke nativo de pipes/timeout/descendentes; o cliente f0be734a fica em checkout separado. A execução contra serviços continua sujeita a gate nominal, com evidência separada de SQL/HTTP/auditoria e cleanup. A regressão compartilhada independente passou597/597, zero falhas/skips, com33/33arquivos estáveis antes/depois; evidência em shared-ag54-a01-regression-2026-09-08.md.
