-- R13 hotfix: a busca por nome usava escape '\' (dois caracteres com
-- standard_conforming_strings), o que devolvia 22025 em producao para qualquer
-- p_search nao vazio. Escape de um caractere e escapes do padrao corrigidos.
