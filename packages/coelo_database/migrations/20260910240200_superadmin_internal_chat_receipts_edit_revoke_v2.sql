-- Chat interno do Superadmin: projecao de recibos, edicao e revogacao da
-- propria mensagem, sobre a baseline de producao.
--
-- Reescreve 20260909191000 (historico) para a forma canonica de producao:
-- capacidade chat.internal.manage sem MFA (ADR 0034, D12), auditoria com 13
-- argumentos, revoke explicito antes do grant. Exige 20260910240100.
  ...
  select pg_catalog.jsonb_build_object('ok',false,'data',null,'error',
    pg_catalog.jsonb_build_object(
      ...
      'http_status',case
        ...
        when p_code in('CHAT_INVALID_INPUT','CHAT_MEMBER_INVALID') then 422
