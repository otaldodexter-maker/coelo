-- E2-R03 publicacoes-agenda: exclusao logica de Circulares no realm interno.
-- O RPC do Principal nao e reutilizado: o ator e a capacidade sao resolvidos
-- por superadmin_internal_context e o recibo fica no ledger administrativo.
begin;
