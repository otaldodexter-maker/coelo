-- Candidato de estrutura (R04, 11/09/2026): recarimbo de 20260901182838 sobre a
-- baseline. Nenhum objeto de Avaliacoes existe em producao. Uma correcao de
-- sintaxe: superadmin_assessment_context_options nao fechava o jsonb_build_object
-- externo antes do INTO (parentese a menos), o que impedia a migration inteira
-- de aplicar ('unexpected end of function definition'); e assessment_v2_save_configuration
-- recebe #variable_conflict use_variable (ambiguidade variavel x coluna). Sem mudanca de regra.
begin;
