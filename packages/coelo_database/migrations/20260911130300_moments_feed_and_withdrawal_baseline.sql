-- Rodada 5 (E2-R05-20260911), principal-chat-sistema. Recarimbo identico da
-- migration historica 20260909216000_moments_feed_and_withdrawal_v1, nunca
-- aplicada em producao: na rota real (11/09 15:12) Momentos responde PGRST202
-- "Could not find the function public.list_visible_moments". Aplicada no
-- espelho coelo_pcs5 sobre baseline + 107 migrations + 130000/130100/130200;
-- pgTAP moments_feed_and_withdrawal_test 23/23. Usa moments_actor (ponte
-- 130000) e a audiencia por role_code: owner cai em school_staff.
--
