-- Fundacao do Agora (Now) sobre a baseline de producao. E a migration
-- historica 20260820220000_now_publication_mvp recarimbada na faixa do grupo
-- principal-chat-sistema (ADR 0034, Decisao 8/P12): producao nunca a recebeu
-- (0/17 objetos presentes em 10/09/2026). Corpo fiel ao original com UMA
-- diferenca: nao cria o bucket 'coelo-now-mvp' no Supabase Storage, porque
-- toda midia nova do MVP nasce no R2 privado (ADR 0032; pacote 20260910190600).
-- O default 'supabase_mvp' de storage_provider e trocado por 'r2' no pacote
-- 190600, na mesma fila; aqui fica a forma original para o diff ser auditavel.
