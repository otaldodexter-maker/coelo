...
final class CoeloAdminUnderlineTab<T> {
  const CoeloAdminUnderlineTab({required this.value, required this.label});

  final T value;
  final String label;
}

/// Abas lineares de diretório (Todos/Ativos/Rascunhos/Inativos ou categorias irmãs).
final class CoeloAdminUnderlineTabs<T> extends StatefulWidget {
  const CoeloAdminUnderlineTabs({
    required this.tabs,
  ...
  final List<CoeloAdminUnderlineTab<T>> tabs;
  final T selected;
  final ValueChanged<T> onSelected;

  @override
  State<CoeloAdminUnderlineTabs<T>> createState() => _CoeloAdminUnderlineTabsState<T>();
}

final class _CoeloAdminUnderlineTabsState<T> extends State<CoeloAdminUnderlineTabs<T>> {
  ...
  @override
  void didUpdateWidget(covariant CoeloAdminUnderlineTabs<T> oldWidget) {
                    ...
                    children: [
                      for (final tab in widget.tabs)
                        SizedBox(
                          ...
                          child: _CoeloAdminUnderlineTabItem<T>(
                            tab: tab,
                ...
                PositionedDirectional(
                  ...
                  child: IgnorePointer(
                    child: ExcludeSemantics(
                      child: SizedBox(
                        key: const ValueKey('coelo-admin-underline-tabs-trailing-fade'),
...
final class _CoeloAdminUnderlineTabItem<T> extends StatefulWidget {
  const _CoeloAdminUnderlineTabItem({
    required this.tab,
    required this.selected,
    required this.onTap,
  ...
  final CoeloAdminUnderlineTab<T> tab;
  final bool selected;
  final VoidCallback onTap;
  final VoidCallback onFocused;

  @override
  State<_CoeloAdminUnderlineTabItem<T>> createState() => _CoeloAdminUnderlineTabItemState<T>();
}

final class _CoeloAdminUnderlineTabItemState<T> extends State<_CoeloAdminUnderlineTabItem<T>> {
    ...
    return Semantics(
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          child: Container(
            key: ValueKey('coelo-admin-underline-tab-${widget.tab.value}'),
