...
sealed class LocationReservationRecurrence {
  ...
  const factory LocationReservationRecurrence.weekly({
...
final class LocationReservationWeekly extends LocationReservationRecurrence {
  const LocationReservationWeekly({required this.weekdays, required this.until});
  ...
  /// Inclusive last day the repetition may produce an occurrence.
...
final class LocationReservationDraft {
  ...
  /// The first dated moment. A weekly recurrence repeats this moment's time of
  /// day on each named weekday until its end date.
