...
| owner.r12-51 | gate/condição | Não aplicável. / Quatro candidatos locais; nenhum aplicado remotamente. / Pendente; transferência documental não certifica execução. | docs/reviews/etapa-2-operacao/next-round/R12-pendencias-herdadas-R11.md | Decidido (ADR 0038): Decisão 8 mantida (dump lógico antes de cada lote) até o primeiro cliente real ou Etapa 3. Fila SQL liberada; C0 aplica os quatro candidatos na ordem serial. |
