...
Este é o recorte atualizado por decisão do Owner. O estado real das tarefas
está em registro.json; a inclusão de Locais não inicia D02, que aguarda seu comando.
...
| D02 | Instituições, Unidades, Turmas, Atividades, Avaliações e Locais completos | 42 |
...
| Total conhecido da rodada | Sete frentes | 120 + lacunas |

As atribuições ainda incluem 14 ações adiadas e2 gates formais para preservar
o comportamento aprovado, sem implementar o que foi adiado. São 136 IDs
selecionados no total, não 136 funcionalidades novas.
...
| Minha conta e Páginas de erro | 9 | E2E aplicável: 3+6; Locais foi transferido integralmente para D02 |
| Total ativo E2E conhecido fora da rodada | 67 | Não abrir essas frentes automaticamente |

Esses 67 pertencem a 83 IDs fora da rodada: 69 MVP (dois não aplicam E2E),
...
- Seleção da rodada:120/187 = 64,17% das ações E2E atualmente inventariadas.
...
- Circulares, Home e granularidade de subtelas ainda limitam a completude
  do inventário. Não usar64,17% como avanço ou prometer100% apenas nesses IDs.
