...
Base56eb3f19, revisão2 de15:42 BRT; HEAD publicado78c53b0a9. App único: apps/superadmin.
...
| people.edit | Formulário: nome legal opcional;recibo preservado no retry da navegação | Write interno e persistência/recarga real |
...
| child-safety.list | Candidato held-golden adc902eaf: epochs/count;SQLv2 candidato48141c195 U43 | Revisar golden;replay/decisão nominal SQL interno;FEv2 não ativado |
| child-safety.child | Contexto ausente não usa unidade alheia;read interno candidato U43 | Replay/decisão nominal SQL interno;runtime/FEv2 não ativado |
...
| internal-users.create | Falhas tratadas;receipt impede duplicar criação confirmada no retry | Contrato nominal de criação/convite |
| internal-users.edit | Negação limpa editor;receipt confirmado separa persistência de navegação | Rota normal de escrita bloqueada |
