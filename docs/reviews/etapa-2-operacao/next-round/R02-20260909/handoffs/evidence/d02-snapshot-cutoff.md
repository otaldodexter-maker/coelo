...
| Turmas / criar-editar / salvar | groups.create, groups.edit | 2e563e8a resultado agregado sem cinco sucessos fictícios (3 P), 583bfd0d recovery Error (1 P). | Vínculos e atomicidade do aggregate completos; integração de reserva não entregue. |
...
outras frentes não foram encerrados. Sem agendamentos criados. Filhos seguem
