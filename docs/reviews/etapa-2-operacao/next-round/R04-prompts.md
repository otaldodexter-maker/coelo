...
JSONs. O Codex não tem esse recurso: o Owner reabre a conversa se ela parar.
...
Colar cada bloco em uma conversa nova, na ferramenta indicada, com o nome
indicado. Ordem de abertura: C0 (coordenação) primeiro, depois as frentes.
...
## G6 — «R04 · Publicações e Agenda (Codex)» — Codex, Luna médio
...
## G7 — «R04 · Operações (Codex)» — Codex, Luna médio
