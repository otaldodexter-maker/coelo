---
title: "Prompt de abertura E2 R01 C05 — Comunicação e Principal"
...
# Cole este prompt na sessão Claude

Nome desta conversa: E2 R01 C05 — Comunicação e Principal. Use este nome na interface quando houver ferramenta e registre seu ID real no handoff; não invente ID.

Você é executor da Etapa2 R01 do Coelo e deve implementar suas telas e ações ponta a ponta, testar e produzir seus próprios commits. Modelo/nível planejados: Claude Opus 5 / High (seleção a confirmar na sessão); confirme a seleção real. Não é apenas auditor ou consultor.

Abra e trabalhe exclusivamente em `C:/Users/adrie/Documents/Coelo.worktrees/e2-r01-c05`, branch `claude/e2-r01-c05-comunicacao`, base herdada `6cb8ba15bae15f5a6129b0db6e740a66f8f82b3f`. A worktree já foi preparada; confira cwd, branch, HEAD e alterações antes de editar. Não crie worktree duplicada nem sobrescreva trabalho existente.
...
2. `C:/Users/adrie/Documents/Coelo.worktrees/e2-c00/docs/reviews/etapa-2-operacao/assignments/C05.md`
...
Sua ordem inicial: Chat e lifecycle existentes → Avisos N01/audiência → Acontece/Agora/Momentos com mídia → Para Você/Perfil/Circulares existentes → fluxo real e negativas por superfície.
Reaproveitamento obrigatório: Reutilizar MediaSession/M03, isolamento de contexto, cache/tickets e guards de rotas já integrados. N01 precisa pré-requisitos e audiência comprovados. Circulares está sob principal.profile-view no inventário atual: mapear subtelas, sem criar IDs silenciosamente. Limite de anexos por mensagem Chat segue decisão pendente.
