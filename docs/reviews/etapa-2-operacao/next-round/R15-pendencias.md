...
| owner.r12-39 | forms.edit, forms.create | done / FE verified na rota real (Bloco A 17/09): pergunta movida por botão (B antes de A), rascunho salvo, carga completa preserva a ordem (position 0/1 no servidor). / BE done (form_save_draft). / E2E verified-e2e via forms.create/edit (409 PT409 em versão defasada). | docs/reviews/evidence/etapa-2/r15-bloco-a/forms-create-edit-delete-file-20260917.md | Concluído 17/09 (Bloco A). Arraste não exercitado por CDP; botão de mover prova a posição final. |
| owner.r12-40 | forms.edit, forms.create | done / FE verified na rota real (Bloco A 17/09): "Renomear seção" por diálogo (contador /120), nome na lista, no título da seção, no editor após reload e na prévia. / BE done (form_save_draft). / E2E verified-e2e via forms.create/edit. | docs/reviews/evidence/etapa-2/r15-bloco-a/forms-create-edit-delete-file-20260917.md | Concluído 17/09 (Bloco A). |
