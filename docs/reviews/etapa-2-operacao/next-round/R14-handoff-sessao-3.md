...
updated_at: "2026-09-15T13:35:00-03:00"
audience: "team"
---
...
|---|---|---|---|
| `0cbcf19f8`, `abdc2fbee`, `6d9210d19` | `assessments.close/reopen`: observação em alvo CDP auxiliar registrada e rebaixada para `pending-verification` por divergência de alvo; sem certificação aceita | `owner.r12-49` | `r14-sessao-3/assessments-close-reopen/assessments-close-reopen-20260915.md`; `deltas-revert-unverified-target-20260915.json` |
| `6d9210d19` | `access-profiles.*`: chave de campo de justificativa adicionada com teste vermelho→verde; rota carregada, sem criação/edição/assign confirmados | `owner.r12-19` a `owner.r12-27` | teste focal; bloqueio descrito abaixo |
| `6d9210d19` | Diagnóstico de `child_safety_change_lifecycle`; sem promoção de `child-safety.*` | `owner.r12-13`, `owner.r12-15`, `owner.r12-16` | `r14-sessao-3/child-safety-lifecycle-504-diagnostico-20260915.md` |
...
- Rebaseline do espelho child safety (fixture `coelo_profile_follow_sync`, capability/ACL/bucket) antes de localizar a espera do 504; a causa raiz permanece não isolada e depois deve-se executar `child-safety.create/edit/suspend`.
...
E2E 157/192, Owner 15/53. `node docs/reviews/validate-trackers.cjs` PASS. Não
foram alterados cabeçalho/contador da R14.
