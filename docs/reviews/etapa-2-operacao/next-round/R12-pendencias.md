...
| owner.r12-36 | meal-plans.create, meal-plans.edit, meal-plans.publish | partial / FE local-green parcial: Prioridade removida; publicação date-only ainda não atende data/hora. / BE inalterado. / E2E pending-verification. | docs/reviews/evidence/etapa-2/r12-coordenacao/meal-plan-form-r12-36-37.md | Definir/persistir instante com fuso e provar visibilidade antes/depois. |
