---
title: "Prompt de abertura E2 R01 C04 — Estruturas e pessoas"
...
Nome desta conversa: E2 R01 C04 — Estruturas e pessoas. Use este nome na interface quando houver ferramenta e registre seu ID real no handoff; não invente ID.
...
2. `C:/Users/adrie/Documents/Coelo.worktrees/e2-c00/docs/reviews/etapa-2-operacao/assignments/C04.md`
...
Sua ordem inicial: Instituições/Unidades/Turmas e Pessoas READ existentes → Locais com snapshot nominal → conectar CHILD/UI/DI → writes/vínculos aprovados e consumidores de mídia → negativas/reload.
Reaproveitamento obrigatório: Preservar D01 (139 testes históricos), PersonDetailReader (242 combinados), CHILD pipeline (38 testes) e reader/painéis Locais (27 focais/88 suíte). Recuperar candidato 9e689374; Test-LocationRemoteSnapshot.Tests.ps1 deve ser executado diretamente, não como suite Pester. Prova estática não substitui replay SQL.
