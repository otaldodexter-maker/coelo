...
source: "R04-prompts.md; coordenacao.json rev 33; ADR 0034 (Decisões 1–15); os três md de pendências em docs/reviews (bloco Estado vigente R04 e atualizações de 14:10 e 14:40); R04-perguntas-ao-owner-20260911.md (duas levas de respostas); ordem do Owner de 11/09/2026 à tarde"
...
- **Frentes trabalham sem parar por 4h30, até por volta de 15:30 de
  11/09/2026**, e entregam tudo ao coordenador: commits publicados, worktree
  limpa ou WIP nomeado, o que fechou, o que ficou pendente, deltas por
  action_id, pacotes SQL e dúvidas ao Owner.
- **15:40**: o coordenador pede a cada frente a revisão de 10 minutos ("você
  entregou tudo mesmo?"). **16:00**: o coordenador encerra as atividades e
  atualiza tudo que é md, spec, ADR, skills e o arquivo da R05; **até 16:40**
  entrega ao Owner o percentual de progresso no formato fixo.
- Se o Owner abrir as conversas depois das 11:00, os horários de relógio
  prevalecem sobre as 4h30; se abrir antes, as 4h30 prevalecem. Em dúvida, a
  frente pergunta ao coordenador no JSON e continua trabalhando.
...
- **Produção:** lotes 8 a 27 aplicados (71 pacotes). Novidades de 11/09:
...
## Estado de partida (14:40 de 11/09, inventário validado)

| Camada | Estado |
| --- | --- |
| Front-end `verified` | 65/231 (28,14%) |
| Front-end `local-green` | 32/231 (13,85%) |
| Front-end aprovação visual do Owner | 52/231 (22,51%) |
| Back-end `local-green` | 91/224 (40,63%) |
| Back-end SQL aplicado em produção | 132/224 (58,93%) |
| Back-end `done` | 68/224 (30,36%) |
| E2E `verified-e2e` | 42/199 (21,11%) |
...
de abertura: C0 primeiro, depois G1 a G7. Toda a R05 roda no Claude; se o
Owner quiser usar a cota do Codex, G7 (Operações) é a frente mais simples de
fechar ponta a ponta e pode ir para ele com o mesmo prompt.

## C0 — «R05 · Coordenação da tarde» — Claude, Fable
...
## G4 — «R05 · Principal, Chat e Sistema» — Claude, Opus
...
## G6 — «R05 · Publicações e Agenda» — Claude, Opus
...
## G7 — «R05 · Operações» — Claude, Opus (ou Codex, se o Owner preferir)
