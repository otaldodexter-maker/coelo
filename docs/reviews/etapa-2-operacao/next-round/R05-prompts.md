...
source: "R04-prompts.md; coordenacao.json rev 36; ADR 0034 (Decisões 1–16); os três md de pendências em docs/reviews (bloco Estado vigente R04 e atualizações de 10:30, 11:05, 11:35, 11:50 e 12:05); R04-perguntas-ao-owner-20260911.md (duas levas de respostas); ordem do Owner de 11/09/2026 à tarde"
...
- **Regra do @ (ADR 0034 Decisão 16, 12:05):** toda entidade nasce com um @
  ...
  o campo Identificador é o @. Estrutura e Acessos aplicam.
