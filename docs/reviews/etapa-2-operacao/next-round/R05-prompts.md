...
- **Regra do @ (ADR 0034 Decisão 16, 12:05):** toda entidade nasce com um @
  hierárquico editável com validação de disponibilidade, troca a cada 30 dias;
  o campo Identificador é o @. Funcionários, responsáveis e crianças também têm
  @, mesmo sem perfil de acesso, visível e editável por quem responde por eles.
  Estrutura e Acessos aplicam.
- **Decisões do Owner (ADR 0034 Decisões 15 e 16 e tabela de respostas em
