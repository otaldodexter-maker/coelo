...
source: "R04-prompts.md; coordenacao.json rev 34; ADR 0034 (Decisões 1–15); os três md de pendências em docs/reviews (bloco Estado vigente R04 e atualizações de 14:10, 14:40 e 15:15); R04-perguntas-ao-owner-20260911.md (duas levas de respostas); ordem do Owner de 11/09/2026 à tarde"
...
- **Frentes trabalham sem parar por 4h30 a partir da abertura (por volta de
  15:30 de 11/09/2026), até 20:00**, e entregam tudo ao coordenador: commits
  publicados, worktree limpa ou WIP nomeado, o que fechou, o que ficou
  pendente, deltas por action_id, pacotes SQL e dúvidas ao Owner.
- **20:10**: o coordenador pede a cada frente a revisão de 10 minutos ("você
  entregou tudo mesmo?"). **20:30**: o coordenador encerra as atividades e
  atualiza tudo que é md, spec, ADR, skills e o arquivo da R05; **até 21:10**
  entrega ao Owner o percentual de progresso no formato fixo.
- Se o Owner abrir as conversas em outro horário, valem 4h30 de trabalho das
  frentes a partir da abertura e, depois, +10, +30 e +70 minutos para as três
  etapas do coordenador; o coordenador anuncia os horários de relógio na sua
  primeira revisão do JSON e as frentes seguem esses horários.
...
## Estado de partida (15:15 de 11/09, inventário validado)
...
Horário: trabalhe sem parar por 4h30 desde a abertura (até 20:00 se abriu às 15:30; o coordenador confirma o horário no JSON); ao terminar, grave finalizado no JSON e faça a mini-revisão de 10 minutos; às 20:10 o coordenador pedirá a revisão final. Depois de 20:30 não retome por conta própria. Só o coordenador escreve em dev, inventário e rastreadores; pacote verde nasce em candidatos/acessos-pessoas e o coordenador aplica; nenhum segredo em Git, chat ou JSON; credencial de qa-r03 em Coelo-backups/qa-r03.env; commits pequenos em português; máximo dois Chrome por conversa e um flutter test por vez.
```
...
Horário: trabalhe sem parar por 4h30 desde a abertura (até 20:00 se abriu às 15:30; o coordenador confirma o horário no JSON); ao terminar, grave finalizado no JSON e faça a mini-revisão de 10 minutos; às 20:10 o coordenador pedirá a revisão final. Depois de 20:30 não retome por conta própria. Só o coordenador escreve em dev, inventário e rastreadores e aplica em produção; commits pequenos em português; um projeto Supabase descartável por conversa, parado ao terminar.
```
...
Horário: trabalhe sem parar por 4h30 desde a abertura (até 20:00 se abriu às 15:30; o coordenador confirma o horário no JSON); ao terminar, grave finalizado no JSON e faça a mini-revisão de 10 minutos; às 20:10 o coordenador pedirá a revisão final. Depois de 20:30 não retome por conta própria. Só o coordenador escreve em dev, inventário e rastreadores; pacote verde nasce em candidatos/publicacoes-agenda (faixa 2026091119xxxx) e o coordenador aplica; nenhum segredo em Git, chat ou JSON; credencial de qa-r03 em Coelo-backups/qa-r03.env; commits pequenos em português; máximo dois Chrome por conversa e um flutter test por vez.
```
...
Horário: trabalhe sem parar por 4h30 desde a abertura (até 20:00 se abriu às 15:30; o coordenador confirma o horário no JSON); ao terminar, grave finalizado no JSON e faça a mini-revisão de 10 minutos; às 20:10 o coordenador pedirá a revisão final. Depois de 20:30 não retome por conta própria. Só o coordenador escreve em dev, inventário e rastreadores; nenhum segredo em Git, chat ou JSON; commits pequenos em português; máximo dois Chrome por conversa e um flutter test por vez.
```
