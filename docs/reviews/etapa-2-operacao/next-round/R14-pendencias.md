...
| owner.r12-34 | meal-plans.model-create, meal-plans.model-edit | done / FE verified: nome de refeição separado do prato, duplicação, renomeação, ordenação e reload provados na rota real. / BE done, sem mudança SQL. / E2E verified-e2e. | docs/reviews/evidence/etapa-2/r14-sessao-2/meal-plans-20260915.md | Fechado na R14; imagem R2 segue em owner.r12-38. |
| owner.r12-35 | meal-plans.model-create, meal-plans.model-edit | done / FE verified: datas específicas adicionadas, ordenadas, removidas individualmente e reidratadas após reload na rota real. / BE done, contrato existente sem mudança SQL. / E2E verified-e2e. | docs/reviews/evidence/etapa-2/r14-sessao-2/meal-plans-20260915.md | Fechado na R14; RLS foi exercitado pelo catálogo autorizado no fluxo. |
| owner.r12-36 | meal-plans.create, meal-plans.edit, meal-plans.publish | done / FE verified: data/hora local preservada e enviada como UTC. / BE done, contrato existente sem SQL novo. / E2E verified-e2e. | docs/reviews/evidence/etapa-2/r14-sessao-2/meal-plans-20260915.md | Fechado: `16/09/2026 08:00` local = `2026-09-16T11:00:00Z` no Supabase real; publicação agendada e reload provados. |
| owner.r12-37 | meal-plans.create, meal-plans.edit | done / FE verified: edição de recorrência e remoção de data específica sem apagar o histórico do payload, com reload real. / BE done, inalterado. / E2E verified-e2e. | docs/reviews/evidence/etapa-2/r14-sessao-2/meal-plans-20260915.md | Fechado na R14; data 18/09 foi removida e não reapareceu após reload. |
