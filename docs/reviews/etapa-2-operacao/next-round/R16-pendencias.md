...
**FE 199/199 (100%), BE 186/186 (100%), E2E 186/186 (100%)**, Owner 45/53 (84,91%) — 18/09, Sessão RESERVA:
owner.r12-04, owner.r12-05, owner.r12-06, owner.r12-08, owner.r12-33 e owner.r12-49 `done` na rota real (eram 39/53 em 17/09);
...
terminais no MVP** (meta FE/BE/E2E da R16 atingida), 8 Owner items abertos/parciais (14 em 17/09), 19 resíduos H, 2 itens da ADR
...
| owner.r12-33 | medication.create, medication.edit, medication.detail | done / verified / done / verified-e2e | docs/reviews/evidence/etapa-2/r16-reserva/medication-bell-v2-20260918.md; docs/reviews/evidence/etapa-2/r14-sessao-10/medication-notifications-20260916.md; specs/053-superadmin-medication-in-app-notifications.md | Concluído 18/09 (Sessão RESERVA): v1 em produção desde o lote 74; v2 `20260918120000` no lote 82 (E7 = b + `recipients-bug`); fixture de equipe `20260918170000` no lote 83 (autorizada pelo Owner). Rota real: plano `2ecf267e` editado (v2, v3) e doses registradas; responsável vê `created/updated/dose` no sino (PostgREST); admin da unidade e educadora da turma gravadas como destinatárias de `plan.updated` e `dose.recorded` em produção (sem conta de login: leitura por RLS provada no pgTAP 27/27). |
