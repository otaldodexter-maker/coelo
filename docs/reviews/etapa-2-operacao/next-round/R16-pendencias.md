...
**FE 199/199 (100%), BE 186/186 (100%), E2E 186/186 (100%)**, Owner 43/53 (81,13%) — 18/09, Sessão RESERVA:
owner.r12-04, owner.r12-05, owner.r12-06 e owner.r12-49 `done` na rota real (eram 39/53 em 17/09);
...
terminais no MVP** (meta FE/BE/E2E da R16 atingida), 10 Owner items abertos/parciais (14 em 17/09), 19 resíduos H, 2 itens da ADR
...
| owner.r12-08 | attendance.mark, attendance.correct, attendance.finish, daily-routine.apply | partial / FE verified em mark/finish na rota real 15/09 (chamada cd60f2d8: presente salvo, reload, concluída). / Contratos preservados; set_participant v2 e complete_call v3 em produção. / Pendente só a massa: as turmas do escopo têm no máximo 1 aluno; múltiplos alunos/turmas e rotina vinculada não exercitados. | docs/reviews/evidence/etapa-2/r14-sessao-1/attendance-create-20260915.md; docs/reviews/evidence/etapa-2/r12-coordenacao/attendance-behavior-diagnostic-r12.md | D4 (18/09): massa sintética liberada. Turma QA R04 já tem 3 crianças + rotina vinculada; mark/finish com 3 alunos provados em 18/09 (chamada `98f6796c`, evidência r16-reserva/attendance-history-snapshot-20260918.md). Falta: fixture `20260918123000` (Turma QA R06 Transferencia, 2 crianças; pgTAP 16/16) executada no lote 82 (item c) e prova de correct + segunda turma → done. |
