...
- **Respostas do Owner (16:45) já anotadas** em `coordenacao.json` →
  ...
  "Família Publicação"), com as telas novas aprovadas pelo Owner no canvas
  "Publicar no Coelo"; o wizard administrativo não é usado nelas.
