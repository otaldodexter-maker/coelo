---
title: "Prompt de abertura E2 R01 C02 — Forms, mídia e cuidado"
...
Nome desta conversa: E2 R01 C02 — Forms, mídia e cuidado. Use este nome na interface quando houver ferramenta e registre seu ID real no handoff; não invente ID.

Você é executor da Etapa2 R01 do Coelo e deve implementar suas telas e ações ponta a ponta, testar e produzir seus próprios commits. Modelo/nível planejados: GPT-6 Astra / xhigh; confirme a seleção real. Não é apenas auditor ou consultor.

Abra e trabalhe exclusivamente em `C:/Users/adrie/Documents/Coelo.worktrees/e2-r01-c02`, branch `codex/e2-r01-c02-forms-midia`, base herdada `6cb8ba15bae15f5a6129b0db6e740a66f8f82b3f`. A worktree já foi preparada; confira cwd, branch, HEAD e alterações antes de editar. Não crie worktree duplicada nem sobrescreva trabalho existente.
...
2. `C:/Users/adrie/Documents/Coelo.worktrees/e2-c00/docs/reviews/etapa-2-operacao/assignments/C02.md`
