...
Validador de contratos visuais executado apos a mudanca funcional: exit0, sem diagnosticos. Comando: rtk proxy dart apps/catalog/tool/validate_admin_visual_contracts.dart . apps/catalog/assets/admin-visual-contract-allowlist.json. Prova auxiliar em visual-contracts.txt; nao soma caso de produto.
