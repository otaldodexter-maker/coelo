...
- Até23:15: PERS-READ01 `bb49760e`, Agenda `a24bb57d`, Circulares
  ...
  `ed23ec20` passaram177/177 no lote anterior. Suporte teve8 novas referências
  comparadas em1 teste focal;24 masters históricos permanecem fora da prova.
  Login single-flight `63258e5e` e hosts Circulares `30371b78`:61/61 em6 suítes.
  Sim/Não Forms `dfe6eb7d`:146/146 em7 suítes; analyzer4 final sem issues.
  Essas contagens se sobrepõem; não representam ações E2E concluídas.
- Inventário vigente: **219 ações / 38 famílias** após inserir os12 IDs de
  Locais nas matrizes, sem duplicar CRUDs genéricos nem promover conclusão.
  Contagens de checkpoints anteriores são históricas; novos itens não
  recebem estimativas artificiais ou status herdado de outra ação.
- Até22:50: STATUS01 `5e461e11`, Agora legenda `30a75522`, contexto do
  header `dac2c598` e matriz Principal `57798893`: **138/138 PASS** em11
  suítes no destino, analyzer3 sem issues. Matriz Principal agora segue
  composição standalone aprovada na spec050, sem mudar rotas ou PNGs.
  Settings browser `242277f6` comprova somente persistência local com sessão
  sintética. R08 foi retido por aviso obsoleto na sequência tema A→B→A;
  correção e RED solicitados ao autor. Quick poll `6341e37d` integrado com
  validação de publicação preservada, ainda sem prova de persistência real.
...
| 3.13 | Instituição / Mapa e locais | `institutions.locations-map` | Catálogo institucional, mapa, marcadores e visibilidade. Falta fechamento Flutter nominal. | `not-reviewed` | B | I | A | C | Completa | a estimar após recorte | Spec de Locais 02/09; permitido/negado/revogado, tenant A/B, persistência/reload e auditoria; R2 privado quando houver mídia. |
...
| 4.12 | Unidade / Mapa e locais | `units.locations-map` | Catálogo e mapa independentes da unidade. Falta fechamento Flutter nominal. | `not-reviewed` | B | I | A | C | Completa | a estimar após recorte | Spec de Locais 02/09; permitido/negado/revogado, tenant A/B, persistência/reload e auditoria; R2 privado quando houver mídia. |
| 4.13 | Unidade / Copiar local | `units.copy-institution-location` | Cópia com proveniência, sem sincronização posterior. Falta fechamento Flutter nominal. | `not-reviewed` | B | I | A | C | Completa | a estimar após recorte | Spec de Locais 02/09; permitido/negado/revogado, tenant A/B, persistência/reload e auditoria; R2 privado quando houver mídia. |
...
| 5.7 | Turma / Local | `groups.location` | Local catalogado ou pontual e reserva recorrente explícita. Falta fechamento Flutter nominal. | `not-reviewed` | B | I | A | C | Completa | a estimar após recorte | Spec de Locais 02/09; permitido/negado/revogado, tenant A/B, persistência/reload e auditoria; R2 privado quando houver mídia. |
...
| 10.7 | Atividade / Local | `activities.location` | Local e reserva explícita da atividade. Falta fechamento Flutter nominal. | `not-reviewed` | B | I | A | C | Completa | a estimar após recorte | Spec de Locais 02/09; permitido/negado/revogado, tenant A/B, persistência/reload e auditoria; R2 privado quando houver mídia. |
...
| 15.7 | Evento / Local | `agenda.location` | Local, disponibilidade e reserva única ou recorrente. Falta fechamento Flutter nominal. | `not-reviewed` | B | I | A | C | Completa | a estimar após recorte | Spec de Locais 02/09; permitido/negado/revogado, tenant A/B, persistência/reload e auditoria; R2 privado quando houver mídia. |
...
| 18.7 | Formulário / Pergunta Local interno | `forms.location-question` | Escolha única ou múltipla; política fixa/dinâmica pendente. Falta fechamento Flutter nominal. | `not-reviewed` | B | I | A | C | Completa | a estimar após recorte | Spec de Locais 02/09; permitido/negado/revogado, tenant A/B, persistência/reload e auditoria; R2 privado quando houver mídia. |
...
| 19.5 | Formulário / Exportar respostas | `forms.responses.export` | Um XLSX com as respostas do formulário; worker, download R2 autorizado, expiração e reload ainda sem prova E2E. CSV/ZIP/PDF não pertencem a esta exceção MVP. | `audited` | B | I | A | C | Completa | a estimar após recorte | XLSX real do formulário inteiro, reautorização server-side, auditoria, R2 privado, expiração, erro/retry e E2E. |
| 19.6 | Formulário / Responder Local interno | `forms.location-answer` | Opções autorizadas e snapshot; reenvio com opção revogada depende de decisão. Falta fechamento Flutter nominal. | `not-reviewed` | B | I | A | C | Completa | a estimar após recorte | Spec de Locais 02/09; permitido/negado/revogado, tenant A/B, persistência/reload e auditoria; R2 privado quando houver mídia. |
...
| 38.1 | Locais / Diretório | `locations.list` | Diretório, filtros, proprietário, tipo e disponibilidade. Falta fechamento Flutter nominal. | `not-reviewed` | B | I | A | C | Completa | a estimar após recorte | Spec de Locais 02/09; permitido/negado/revogado, tenant A/B, persistência/reload e auditoria; R2 privado quando houver mídia. |
| 38.2 | Local / Criar e editar | `locations.create-edit` | Interno/externo, endereço, andar, foto e públicos. Falta fechamento Flutter nominal. | `not-reviewed` | B | I | A | C | Completa | a estimar após recorte | Spec de Locais 02/09; permitido/negado/revogado, tenant A/B, persistência/reload e auditoria; R2 privado quando houver mídia. |
| 38.3 | Local / Detalhe e vínculos | `locations.detail-links` | Mapa/foto, agenda e relações autorizadas. Falta fechamento Flutter nominal. | `not-reviewed` | B | I | A | C | Completa | a estimar após recorte | Spec de Locais 02/09; permitido/negado/revogado, tenant A/B, persistência/reload e auditoria; R2 privado quando houver mídia. |
| 38.4 | Locais / Agendamento | `locations.schedule` | Reservas, recorrência, conflitos, política e override auditado. Falta fechamento Flutter nominal. | `not-reviewed` | B | I | A | C | Completa | a estimar após recorte | Spec de Locais 02/09; permitido/negado/revogado, tenant A/B, persistência/reload e auditoria; R2 privado quando houver mídia. |
