...
status: reconciliado-aguarda-regressao-focal
...
As capturas R06 ui-12 a ui-15 continuam validas para abrir a resposta, enviar e observar o resumo apos reload. A R08 nao promove novo E2E com esta leitura documental; recertifica apenas a regressao local causada pelas chaves de ordem adicionadas ao leitor.
