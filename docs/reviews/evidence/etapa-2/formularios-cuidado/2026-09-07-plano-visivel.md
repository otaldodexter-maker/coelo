...
- Cuidado: reload pós-mutação corrigido em fatia separada, cinco REDs nos cinco comandos; 12 testes novos e regressão177/177 em17arquivos. Vista atual preservada sem impedir duas atualizações da mesma vista. Review aprovado; evidência `2026-09-08-care-mutation-refresh-context.md`. Sem backend/clínica ou conclusão E2E.
