...
updated: 2026-09-07T21:31:42-03:00
---
...
| Usuários internos | Editar / suspender / reativar / revogar; replay 20260901210000 | 1/6 — dependências e fixture analisadas | Projeção e comandos superadmin_internal_users; versões de perfil, membership e auth link; audit reason_code | replay_manifest / root | Auth45 + uma migration futura + dois preflights = 48 arquivos; snapshot analisado tinha 29 asserts e problemas de fixture/negativas. O coordenador recebeu a revisão e0efd98e com 45 asserts; revisão central e pacote nominal ainda pendentes. Divergência de token identificada apenas estaticamente | Coordenador definir pacote nominal após N01; preservar autorização real das chamadas e corrigir somente a fixture acordada |
...
| Atividades | A01: pré-requisitos do replay funcional | 1/6 — cadeia mínima conferida | Auth45 e sete migrations Activities v2, somente leitura; nenhum replay realizado | replay_manifest; contexto Engenheiro 2 / E2E5 | Base mínima identificada: 52 canônicas + dois preflights = 54 arquivos. Nenhuma dependência adicional de Chat v2, Notices ou cleanup de labels foi identificada. Teste E2E5 corrigido para roles reais foi lido; a migration corretiva ainda estava vazia nesse snapshot | Entregar nomes/hashes/ordem ao coordenador; definir seletor nominal A01 e receber SQL corretivo antes de reserva de execução |
