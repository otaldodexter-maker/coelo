...
updated: 2026-09-07T22:17:15-03:00
---
...
| Formulários | F-READ: FormsApi.listDirectory / forms.list interno | 3/6 — seletor nominal autorizado em preparação | Auth45 + duas Forms + helper20260827235500 = 48 canônicas + dois preflights; nenhum replay F-READ | replay_auth_rls writer; replay_runner review; root; apoio replay_manifest | Base50 revisada; helper preserva SAI_INVALID_ARGUMENT e envelope400, também cria dois RPCs institucionais. Fixture9f31e88e com86TAP estáticos recebida. Reader futuro não está na base | Testes/parse/review do seletor50; reserva de execução nominal. GREEN51 exige reader/hash revisados |
