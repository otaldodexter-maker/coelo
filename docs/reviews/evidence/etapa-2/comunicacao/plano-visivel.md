...
| 1/6 | Chat / anexo imagem, mídia M03 | Contratos e REDs locais reservados; catálogo ainda não alterado | `review_media_session`, `crosswalk_media` | Primeira fatia M03 concedida; domínio communication/chat-message reconciliado pelo Coordenador; próximo gate contrato consumível e testes de segurança |
