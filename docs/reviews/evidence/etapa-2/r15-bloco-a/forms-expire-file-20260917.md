...
| Expiração pelo worker | Sem ação do usuário: ticket de 30 min vence às ~17:24Z; o cron de 5 min executa o worker. | RESULTADO_EXPIRACAO | RELOAD_EXPIRACAO | NEGATIVA_EXPIRACAO |
