...
| Agenda | Readers list/get/contexts 039 | 1/6 proposta `b22718f` | Crosswalk + matriz RED em Markdown; nenhum SQL executável | root + `activities_sql_review` | Forma/capabilities/hierarquia/audit revisados como proposta | Aceite nominal, base efetiva e método de grants sintéticos antes de fixture |
