...
| Atividades | Runtime Flutter/PostgREST A01 | 3/6 harness candidato `f5b0e5b` | Test-only; zero HTTP/SQL nesta preparação | root + reviews cliente/base; Eng1 operador futuro | 13guards PASS e1runtime SKIP forçado; analyzer/review PASS | Lease nominal base55, seed COMMIT isolado, platform.read explícito, JWT sintéticos e audit independente |
