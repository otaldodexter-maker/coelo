# Prova de RPC em producao com a sessao qa-r03. Credenciais so em memoria; nunca imprime.
...
def env(path):
    ...
    return d
e=env('C:/Users/adrie/Documents/Coelo.worktrees/e2-r05-principal-chat-sistema/apps/superadmin/.env.local')
q=env('C:/Users/adrie/Documents/Coelo-backups/qa-r03.env')
