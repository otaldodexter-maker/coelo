...
Complemento do Owner (12:15), texto: "pública de toda entidade, sim inclusive funcionários, responsaveis e crianças tem @ por mais que elas não tenham perfil. mas eles podem ver e editar". Leitura registrada: o @ vale também para funcionários, responsáveis e crianças, mesmo quem não tem perfil de acesso ao app; quem responde por eles (a instituição para funcionários, os responsáveis para a criança) pode ver e editar esse @, dentro da mesma regra de disponibilidade e 30 dias.
