...
- Usersmin48 real:1PASS/2FAIL, base integral; corretiva de projeção/count e
  ...
  platform.read adicional sem contrato. Evidências integradas9579e014/9b0d08aa.
- F-READ: parser original42601/corrigido com4 caracteres foi comprovado pelo
  Eng1 em PostgreSQL17.6,3/3TAP e cleanup. Materializador `7b8dfb0a` passou
 17/17Pester no destino; não é reader51 executado nem migration histórica
  alterada. Perfis50/51 passaram160/160Pester central; Model49+entrypoint
  passaram32/32 em lote separado. Derivação50 completa ainda em preparação.
- Preparações locais nominais de autoria de Forms e catálogo de Locais foram
  delimitadas com guards de coexistência, recibos e preflights explícitos.
  Não constituem matriz de capabilities aprovada/remota nem escrita produtiva.
  M03 mantém gates de proveniência operacional, AAL e concorrência documentados.
- Inventário vigente: **219 ações / 38 famílias**, incluindo12 IDs únicos
  de Locais. Todos permanecem abertos; proposta/contrato ou teste isolado não
  herda conclusão dos CRUDs genéricos. Contagens de checkpoints são históricas.
- F-READ50 executado pelo Eng1 às22:30:37: **SQLSTATE42601 antes do
  endpoint, zero pgTAP**; migration20260813155005, função
  form_item_config_valid. Cleanup independente22:32:52 sem recursos nominais.
  Preparação autorizada de derivação local explícita com dois pares de
  parênteses em CASE, origem canônica intacta e hashes fechados; não é replay
  canônico concluído, correção remota ou GREEN51. Seletor/evidência ecf54d40
  aguardam integração central. A01 fixture97 ee212cb5 revisada: preserva89
  provas e acrescenta8 de audit; RED55v1 autorizado serialmente após gates.
- M03: parecer Eng2 documenta resolver por upload_session e locks ainda não
  implementados/comprovados. E1 valida âncoras/AAL e E3 concilia complete,
  send e discard; autorização após espera/expiração e revogação permanece
  gate real. Nenhum helper Auth compartilhado ou produção foi alterado.
...
| 38 | Locais: diretório, criar/editar, detalhe e agenda | catálogo, proprietário, visibilidade, reservas e R2 | `not-reviewed` | Contrato nominal, coexistência legada, autorização e prova real ainda abertos. |
...
| 3 | `institutions` | `institutions.locations-map` | Catálogo institucional, mapa, marcadores e visibilidade. Contrato, autorização, coexistência legada e prova SQL/E2E específicos ainda abertos. | `not-reviewed` | RED nominal. | Contrato e testes locais. | Autorização e tenant A/B. | Regressão, auditoria, cleanup e remoto autorizado. | Completa | a estimar após recorte | Spec de Locais 02/09; permitido/negado/revogado, tenant A/B, persistência/reload e auditoria; R2 privado quando houver mídia. |
...
| 4 | `units` | `units.locations-map` | Catálogo e mapa independentes da unidade. Contrato, autorização, coexistência legada e prova SQL/E2E específicos ainda abertos. | `not-reviewed` | RED nominal. | Contrato e testes locais. | Autorização e tenant A/B. | Regressão, auditoria, cleanup e remoto autorizado. | Completa | a estimar após recorte | Spec de Locais 02/09; permitido/negado/revogado, tenant A/B, persistência/reload e auditoria; R2 privado quando houver mídia. |
| 4 | `units` | `units.copy-institution-location` | Cópia com proveniência, sem sincronização posterior. Contrato, autorização, coexistência legada e prova SQL/E2E específicos ainda abertos. | `not-reviewed` | RED nominal. | Contrato e testes locais. | Autorização e tenant A/B. | Regressão, auditoria, cleanup e remoto autorizado. | Completa | a estimar após recorte | Spec de Locais 02/09; permitido/negado/revogado, tenant A/B, persistência/reload e auditoria; R2 privado quando houver mídia. |
...
| 5 | `groups` | `groups.location` | Local catalogado ou pontual e reserva recorrente explícita. Contrato, autorização, coexistência legada e prova SQL/E2E específicos ainda abertos. | `not-reviewed` | RED nominal. | Contrato e testes locais. | Autorização e tenant A/B. | Regressão, auditoria, cleanup e remoto autorizado. | Completa | a estimar após recorte | Spec de Locais 02/09; permitido/negado/revogado, tenant A/B, persistência/reload e auditoria; R2 privado quando houver mídia. |
...
| 10 | `activities` | `activities.location` | Local e reserva explícita da atividade. Contrato, autorização, coexistência legada e prova SQL/E2E específicos ainda abertos. | `not-reviewed` | RED nominal. | Contrato e testes locais. | Autorização e tenant A/B. | Regressão, auditoria, cleanup e remoto autorizado. | Completa | a estimar após recorte | Spec de Locais 02/09; permitido/negado/revogado, tenant A/B, persistência/reload e auditoria; R2 privado quando houver mídia. |
...
| 15 | `agenda` | `agenda.location` | Local, disponibilidade e reserva única ou recorrente. Contrato, autorização, coexistência legada e prova SQL/E2E específicos ainda abertos. | `not-reviewed` | RED nominal. | Contrato e testes locais. | Autorização e tenant A/B. | Regressão, auditoria, cleanup e remoto autorizado. | Completa | a estimar após recorte | Spec de Locais 02/09; permitido/negado/revogado, tenant A/B, persistência/reload e auditoria; R2 privado quando houver mídia. |
...
| 18 | `forms_authoring` | `forms.location-question` | Escolha única ou múltipla; política fixa/dinâmica pendente. Contrato, autorização, coexistência legada e prova SQL/E2E específicos ainda abertos. | `blocked-decision` | RED nominal. | Contrato e testes locais. | Autorização e tenant A/B. | Regressão, auditoria, cleanup e remoto autorizado. | Completa | a estimar após recorte | Spec de Locais 02/09; permitido/negado/revogado, tenant A/B, persistência/reload e auditoria; R2 privado quando houver mídia. |
| 19 | `forms_responses` | `forms.responses.export` | XLSX único do formulário inteiro; worker, catálogo e entrega R2 privada com autorização e auditoria ainda sem fechamento nominal. Não CSV/ZIP/PDF nem arquivo por resposta. | `fail-closed` | RED nominal. | Contrato e arquivo local. | Tenant A/B, negações e R2 autorizado. | Worker, auditoria, expiração, cleanup e E2E. | Completa | a estimar após recorte | XLSX válido, ator/recurso/escopo reautorizados, revogação e expiração, sem path/segredo no DTO, cleanup e reload. |
...
| 19 | `forms_responses` | `forms.location-answer` | Opções autorizadas e snapshot; reenvio com opção revogada depende de decisão. Contrato, autorização, coexistência legada e prova SQL/E2E específicos ainda abertos. | `blocked-decision` | RED nominal. | Contrato e testes locais. | Autorização e tenant A/B. | Regressão, auditoria, cleanup e remoto autorizado. | Completa | a estimar após recorte | Spec de Locais 02/09; permitido/negado/revogado, tenant A/B, persistência/reload e auditoria; R2 privado quando houver mídia. |
...
| 38 | `locations` | `locations.list` | Diretório, filtros, proprietário, tipo e disponibilidade. Contrato, autorização, coexistência legada e prova SQL/E2E específicos ainda abertos. | `not-reviewed` | RED nominal. | Contrato e testes locais. | Autorização e tenant A/B. | Regressão, auditoria, cleanup e remoto autorizado. | Completa | a estimar após recorte | Spec de Locais 02/09; permitido/negado/revogado, tenant A/B, persistência/reload e auditoria; R2 privado quando houver mídia. |
| 38 | `locations` | `locations.create-edit` | Interno/externo, endereço, andar, foto e públicos. Contrato, autorização, coexistência legada e prova SQL/E2E específicos ainda abertos. | `not-reviewed` | RED nominal. | Contrato e testes locais. | Autorização e tenant A/B. | Regressão, auditoria, cleanup e remoto autorizado. | Completa | a estimar após recorte | Spec de Locais 02/09; permitido/negado/revogado, tenant A/B, persistência/reload e auditoria; R2 privado quando houver mídia. |
| 38 | `locations` | `locations.detail-links` | Mapa/foto, agenda e relações autorizadas. Contrato, autorização, coexistência legada e prova SQL/E2E específicos ainda abertos. | `not-reviewed` | RED nominal. | Contrato e testes locais. | Autorização e tenant A/B. | Regressão, auditoria, cleanup e remoto autorizado. | Completa | a estimar após recorte | Spec de Locais 02/09; permitido/negado/revogado, tenant A/B, persistência/reload e auditoria; R2 privado quando houver mídia. |
| 38 | `locations` | `locations.schedule` | Reservas, recorrência, conflitos, política e override auditado. Contrato, autorização, coexistência legada e prova SQL/E2E específicos ainda abertos. | `not-reviewed` | RED nominal. | Contrato e testes locais. | Autorização e tenant A/B. | Regressão, auditoria, cleanup e remoto autorizado. | Completa | a estimar após recorte | Spec de Locais 02/09; permitido/negado/revogado, tenant A/B, persistência/reload e auditoria; R2 privado quando houver mídia. |
