...
O diretório não usa dashboard inicial: 
ova chamada` é uma ação simples em card. Quando o contexto mínimo é válido, `Chamada` pode ser acessada diretamente pela navegação lateral. Presente, Falta, Atraso e Saída antecipada permanecem disponíveis por aluno; marcar todos é apenas um atalho.
