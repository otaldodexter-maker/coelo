...
e ícone ficam explicitamente alinhados ao topo e contidos na caixa, inclusive
com texto a 200%.
...
Telefone e celular brasileiros usam a máscara compartilhada
`+55 (DD) 3333-4444` ou `+55 (DD) 99999-9999`. A interface apresenta os rótulos
`Telefone` e `Celular`; por compatibilidade com o contrato existente, Celular
continua vinculado a `whatsapp_number`, normalizado para E.164 ao salvar, sem
alterar schema ou regra de contato.
