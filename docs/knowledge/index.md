...
| team | Superadmin / Coelo (Principal) | [Família visual Publicação (Coelo Principal)](team/publicacao-visual-family.md) | validated | `.agents/skills/coelo-ui/references/principal-visual-surfaces.md`; `docs/reviews/evidence/etapa-2/referencias/publicacao/aprovadas-20260911/` |
