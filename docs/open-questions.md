...
| OQ-016 | Importacao MVP | Quais templates de importacao entram primeiro: usuarios, unidades, grupos ou turmas? | `specs/012-superadmin-mvp.md` | Definir a primeira ordem de importacao antes da implementacao. |
