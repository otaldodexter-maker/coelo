...
**Interfaces:**
- Consumes: `CatalogFoundation`, `CoeloAdminMultiSelectFilter` e tokens de tema.
...
Compor popup, ação de fechar, item discreto, linhas contínuas e seletores sem
criar componente público ou importar código do Superadmin.
