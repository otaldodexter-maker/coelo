...
Future<SuperadminAuthScope> createSuperadminAuthScope({
  ...
  try {
    ...
    return SuperadminAuthScope(
      ...
      // Com a ponte de ator (lote 10, 220400) o usuario interno tem ator no
      // realm de pessoas e o repositorio legado responde leitura E escrita;
      // o v2 interno (lote 4) continua somente leitura, entao fica de fora.
