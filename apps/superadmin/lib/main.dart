...
Future<void> main() async {
  ...
  runApp(
    SuperadminApp(
      ...
      personHandleRepository: authScope.personHandleRepository,
      ...
      staffAccessRepository: authScope.staffAccessRepository,
      ...
      formsAnonymousEditSecrets: authScope.formsAnonymousEditSecrets,
      tourStore: authScope.tourStore,
      ...
      contextNotificationRepository: authScope.contextNotificationRepository,
