...
final class SupabaseFormsApi implements FormsApi {
  ...
  @override
  Future<FormDefinition> getEditor(String formId) => _guard(
    () async => FormDefinitionDto.fromJson(
  ...
  Future<T> _guard<T>(Future<T> Function() operation) async {
    try {
      ...
      throw FormApiException(_failureKind(error.code), error.message);
    } on WireFormatException catch (error) {
      throw FormApiException(FormApiFailureKind.unknown, error.message);
    } on FormatException catch (error) {
      throw FormApiException(FormApiFailureKind.unknown, error.message);
    } on Object {
      throw const FormApiException(FormApiFailureKind.unknown, 'Invalid forms backend response.');
    }
  }
...
FormFileJob _fileJob(Map<String, Object?> payload) => FormFileJob(
  ...
  downloadPath: payload['download_path'] as String?,
