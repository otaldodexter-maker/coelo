  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        CoeloTourAnchor(
          id: 'publish.caption',
          child: _CaptionField(value: draft.caption, onChanged: controller.setCaption),
        ),
        const SizedBox(height: CoeloSpacing.space5),
        ...
        CoeloTourAnchor(
          id: 'publish.audience',
          union: true,
          child: _ContextCard(contextData: controller.context),
        ),
        const SizedBox(height: CoeloSpacing.space3),
        CoeloTourAnchor(
          id: 'publish.audience',
          union: true,
          child: _AudienceSelector(selected: draft.audiences, onToggle: controller.toggleAudience),
        ),
        const SizedBox(height: CoeloSpacing.space4),
        CoeloTourAnchor(
          id: 'publish.schedule',
          union: true,
          child: _ScheduleField(value: draft.publishAt, onChanged: controller.setPublishAt),
        ),
        const SizedBox(height: CoeloSpacing.space5),
