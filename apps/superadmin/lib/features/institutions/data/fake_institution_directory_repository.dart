...
final demoInstitutionRecords = List<InstitutionRecord>.unmodifiable([
  ...
  _record(
    ...
    unitGroupCounts: const [12, 10, 8, 6],
  ),
  _record(
  ...
  _record(
    ...
    status: InstitutionStatus.onboarding,
    plan: InstitutionPlan.complete,
    unitGroupCounts: const [22, 18, 14, 10],
  ),
  _record(
    id: 'demo-institution-encanto',
    name: 'Núcleo Encanto',
    type: 'Educação infantil',
    city: 'Manaus',
    state: 'AM',
    status: InstitutionStatus.draft,
    plan: InstitutionPlan.essential,
    unitGroupCounts: const [7],
  ),
  _record(
    id: 'demo-institution-serra-azul',
    name: 'Colégio Serra Azul',
    type: 'Colégio',
    city: 'Vitória',
    state: 'ES',
    status: InstitutionStatus.suspended,
    plan: InstitutionPlan.custom,
    unitGroupCounts: const [16, 12],
  ),
  _record(
    id: 'demo-institution-girassol',
