...
final class PrincipalMomentsPublicationRoute extends StatefulWidget {
  ...
  /// Marca a composicao como hospedada na area de conteudo do shell do
  /// Superadmin, que mantem seu proprio menu visivel (decisao do Owner de
  /// 09/09/2026) e ja consumiu os insets do sistema.
  final bool embedded;
