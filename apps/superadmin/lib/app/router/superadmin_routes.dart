abstract final class SuperadminRoutes {
  ...
  static const agendaEventCreate = '/agenda/events/new';
  static const agendaEventCreateName = 'agenda-event-create';
  static const agendaEventDetail = '/agenda/events/:eventId';
  static const agendaEventDetailName = 'agenda-event-detail';
  static const agendaEventEdit = '/agenda/events/:eventId/edit';
  static const agendaEventEditName = 'agenda-event-edit';
  static const agendaRequests = '/agenda/requests';
  static const agendaRequestsName = 'agenda-requests';
  static const agendaApprovals = '/agenda/approvals';
  static const agendaApprovalsName = 'agenda-approvals';
  static const agendaPermissions = '/agenda/permissions';
  static const agendaPermissionsName = 'agenda-permissions';
  ...
  static const plansName = 'plans';
  static const planCreate = '/plans/new';
  static const planCreateName = 'plan-create';
  static const planEdit = '/plans/:planId/edit';
  static const planEditName = 'plan-edit';
  ...
  static const circularEdit = '/circulars/:circularId/edit';
  static const circularEditName = 'circular-edit';
  ...
  static const principalHappens = '/principal-happens';
  ...
  static const principalMomentsPublishName = 'principal-moments-publish';
  static const principalNow = '/principal-now';
  static const principalNowName = 'principal-now';
  static const principalNowPublication = '/principal-now/publication';
  ...
  static const principalOfficialProfile = '/principal-official/:handle';
  static const principalOfficialProfileName = 'principal-official-profile';
  ...
  static const devCircularEdit = '/dev/circulars/:circularId/edit';
  ...
  static const devAgendaApprovals = '/dev/agenda/approvals';
  static const devAgendaApprovalsName = 'dev-agenda-approvals';
