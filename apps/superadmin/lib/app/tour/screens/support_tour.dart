...
const supportHeaderTourStep = CoeloTourStep(
  ...
  text:
      'Acompanhe os chamados e solicitações da operação.',
);
...
const supportSearchTourStep = CoeloTourStep(
  ...
  text:
      'Encontre um chamado pelo texto.',
);
...
const supportFiltersTourStep = CoeloTourStep(
  ...
  title: 'Filtros',
  text:
      'Menu, Responsável, Leitura e Tela. "Limpar filtros" volta ao início.',
);
...
const supportViewTourStep = CoeloTourStep(
  ...
  text:
      'Alterne entre o quadro por etapa e a tabela.',
);
...
const supportFilesTourStep = CoeloTourStep(
  ...
  title: 'Exportar',
  text:
      'Exporte os chamados em CSV ou XLSX.',
);
...
const supportBodyTourStep = CoeloTourStep(
  ...
  title: 'O quadro',
  text:
      'Arraste ou use "Mover para" para mudar a etapa; escolha responsáveis no card.',
);
...
const supportDetailTourStep = CoeloTourStep(
  ...
  title: 'O chamado',
  text:
      'Selecione um chamado para ver mensagens, anexos e responder.',
);
