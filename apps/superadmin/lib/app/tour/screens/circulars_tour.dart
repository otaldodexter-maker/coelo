...
const circularsHeaderTourStep = CoeloTourStep(
  ...
  title: 'Circulares',
  text: 'Comunicados formais com texto, mídia e perguntas.',
);
...
const circularsFiltersTourStep = CoeloTourStep(
  ...
  title: 'Contexto',
  text: 'Filtre pela instituição, unidade ou turma.',
);
...
const circularsFilesTourStep = CoeloTourStep(
  ...
  text: 'Importe ou exporte circulares.',
);
...
const circularsTabsTourStep = CoeloTourStep(
  ...
  title: 'Situação',
  text: 'Cada aba é uma situação da circular.',
);
...
const circularsBodyTourStep = CoeloTourStep(
  ...
  title: 'A lista',
  text: 'Título, resumo e status. Clique para abrir.',
);
