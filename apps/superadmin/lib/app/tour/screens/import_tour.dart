...
const importHeaderTourStep = CoeloTourStep(
  ...
  title: 'Importações',
  text:
      'Cada arquivo importado, com entidade, destino e quantidade de registros.',
);
...
const importSearchTourStep = CoeloTourStep(
  ...
  text:
      'Encontre uma importação pelo nome do arquivo.',
);
...
const importFilesTourStep = CoeloTourStep(
  ...
  text:
      'Importe um novo arquivo ou exporte o histórico.',
);
...
const importCreateTourStep = CoeloTourStep(
  ...
  text:
      'Abre o assistente: escolha a entidade, envie o arquivo, confira e confirme.',
);
...
const importBodyTourStep = CoeloTourStep(
  ...
  title: 'A lista',
  text:
      'Arquivo, entidade, destino, registros, data e responsável de cada importação.',
);
