...
const internalUsersSearchTourStep = CoeloTourStep(
  ...
  title: 'Buscar',
  text: 'Nome, e-mail, CPF, celular ou cargo.',
);
...
const internalUsersFiltersTourStep = CoeloTourStep(
  ...
  title: 'Filtros',
  text: 'Perfil, Vínculo e Alcance. "Limpar filtros" volta ao início.',
);
...
const internalUsersCreateTourStep = CoeloTourStep(
  ...
  text: 'Abre o formulário de um novo acesso interno.',
);
...
const internalUsersBodyTourStep = CoeloTourStep(
  ...
  title: 'A lista',
  text: 'Perfil, escopo, situação do convite e última revisão de cada usuário.',
);
