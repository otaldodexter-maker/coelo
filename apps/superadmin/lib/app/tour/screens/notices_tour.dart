...
const noticesHeaderTourStep = CoeloTourStep(
  ...
  title: 'Comunicações',
  text: 'Avisos e comunicados enviados às famílias e à equipe.',
);
...
const noticesFiltersTourStep = CoeloTourStep(
  ...
  title: 'Estado',
  text: 'Rascunho, publicado, pausado ou inativo.',
);
...
const noticesFilesTourStep = CoeloTourStep(
  ...
  text: 'Importe ou exporte comunicações.',
);
...
const noticesTabsTourStep = CoeloTourStep(
  ...
  title: 'Tipo',
  text: 'Cada aba é um tipo de comunicação.',
);
...
const noticesCreateTourStep = CoeloTourStep(
  ...
  text: 'Abre o formulário: conteúdo, público e agendamento.',
);
...
const noticesBodyTourStep = CoeloTourStep(
  ...
  title: 'A lista',
  text: 'Nas ações: Editar, Publicar, Pausar, Reativar ou Inativar (com motivo para a auditoria).',
);
