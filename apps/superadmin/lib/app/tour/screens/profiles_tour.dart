...
const profilesHeaderTourStep = CoeloTourStep(
  ...
  text:
      'Modelos de acesso por módulo, tela e ação. Um perfil define o que cada pessoa vê e faz.',
);
...
const profilesLeadingTourStep = CoeloTourStep(
  ...
  text:
      'Alterne entre os perfis e a lista de capacidades do Principal.',
);
...
const profilesSearchTourStep = CoeloTourStep(
  ...
  title: 'Buscar',
  text:
      'Busque um perfil pelo nome ou uma capacidade.',
);
...
const profilesFiltersTourStep = CoeloTourStep(
  ...
  title: 'Escopo',
  text:
      'Filtre pelo escopo máximo do perfil.',
);
...
const profilesFilesTourStep = CoeloTourStep(
  ...
  text:
      'Importe perfis de uma planilha ou exporte em CSV ou XLSX.',
);
...
const profilesTabsTourStep = CoeloTourStep(
  ...
  title: 'Domínio',
  text:
      'Superadmin, instituição, unidade… cada aba mostra os perfis daquele domínio.',
);
...
const profilesCreateTourStep = CoeloTourStep(
  ...
  title: 'Criar perfil',
  text:
      'Abre o formulário de um novo perfil. Em perfis existentes você pode duplicar.',
);
...
const profilesBodyTourStep = CoeloTourStep(
  ...
  title: 'A lista',
  text:
      'Perfil, descrição, escopo máximo, vínculos e tipo. Abra para editar as permissões.',
);
