...
const activitiesHeaderTourStep = CoeloTourStep(
  ...
  title: 'Atividades',
  text: 'Aulas, oficinas e projetos vinculados a unidades e turmas.',
);
...
const activitiesLeadingTourStep = CoeloTourStep(
  ...
  text: '"Modelos de atividade" são a base reutilizável; "Atividades" são as instâncias em turmas.',
);
...
const activitiesSearchTourStep = CoeloTourStep(
  ...
  title: 'Buscar',
  text: 'Busque por nome ou descrição.',
);
...
const activitiesFiltersTourStep = CoeloTourStep(
  ...
  title: 'Filtros',
  text: 'Instituições, Unidades, Turmas e Origem. Em modelos: Origem e Categorias.',
);
...
const activitiesViewTourStep = CoeloTourStep(
  ...
  text: 'Na tabela, veja Agrupado, Por Unidades ou Por Turmas.',
);
...
const activitiesFilesTourStep = CoeloTourStep(
  ...
  text: 'Importe de planilha ou exporte em CSV ou XLSX.',
);
...
const activitiesTabsTourStep = CoeloTourStep(
  ...
  title: 'Situação',
  text: 'Todos, Ativos, Rascunhos, Inativos; modelos têm também Arquivados.',
);
...
const activitiesCreateTourStep = CoeloTourStep(
  ...
  text: 'Abre o formulário. Num modelo, "Começar a partir deste modelo" já preenche a atividade.',
);
...
const activitiesBodyTourStep = CoeloTourStep(
  ...
  title: 'A lista',
  text: 'Abra uma atividade para ver turmas, configuração avaliativa e lançamentos.',
);
