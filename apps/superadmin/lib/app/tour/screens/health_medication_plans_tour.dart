...
const healthMedicationPlansHeaderTourStep = CoeloTourStep(
  ...
  text:
      'Medicamentos autorizados, horários e o registro de cada dose aplicada.',
);
...
const healthMedicationPlansSearchTourStep = CoeloTourStep(
  ...
  title: 'Buscar',
  text:
      'Nome da criança ou do medicamento.',
);
...
const healthMedicationPlansFiltersTourStep = CoeloTourStep(
  ...
  title: 'Filtros',
  text:
      'Status do plano e situação da dose.',
);
...
const healthMedicationPlansViewTourStep = CoeloTourStep(
  ...
  text:
      'A tabela agrupa por criança ou por horário.',
);
...
const healthMedicationPlansFilesTourStep = CoeloTourStep(
  ...
  text:
      'Importe planos ou exporte em CSV ou XLSX.',
);
...
const healthMedicationPlansCreateTourStep = CoeloTourStep(
  ...
  text:
      'Abre o formulário: criança, medicamento, vigência e horários.',
);
...
const healthMedicationPlansBodyTourStep = CoeloTourStep(
  ...
  title: 'A lista',
  text:
      'Criança, medicamento, vigência, horários e contexto responsável.',
);
