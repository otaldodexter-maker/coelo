...
const attendanceHeaderTourStep = CoeloTourStep(
  ...
  title: 'Assiduidade',
  text: 'Visão consolidada de presença e chamadas no seu escopo.',
);
...
const attendanceActionsTourStep = CoeloTourStep(
  ...
  text: '"Nova chamada" abre o lançamento de hoje; Exportar gera CSV ou XLSX do que está na tela.',
);
...
const attendanceKpisTourStep = CoeloTourStep(
  ...
  title: 'Indicadores',
  text: 'Presença geral, chamadas pendentes, faltas no período e itens em revisão.',
);
...
const attendanceAttentionTourStep = CoeloTourStep(
  ...
  text: 'Pendências que precisam de ação: chamadas atrasadas e correções aguardando.',
);
...
const attendanceRankingTourStep = CoeloTourStep(
  ...
  text: 'Ranking de presença por unidade ou turma. "Ver todos" abre a lista completa.',
);
...
const attendanceChartTourStep = CoeloTourStep(
  ...
  text: 'Gráfico do período atual comparado ao anterior.',
);
...
const attendanceRecentTourStep = CoeloTourStep(
  ...
  text: 'Busque, filtre por status, ordene e abra qualquer chamada recente.',
);
