...
const peopleSearchTourStep = CoeloTourStep(
  ...
  text: 'Encontre uma pessoa pelo nome.',
);
...
const peopleFiltersTourStep = CoeloTourStep(
  ...
  title: 'Filtros',
  text: 'Tipo, instituição, unidade, turma, papel, localidade e situação de acesso.',
);
...
const peopleViewTourStep = CoeloTourStep(
  ...
  text: 'Cards mostram vínculos e crianças; a tabela mostra papel contextual e acesso.',
);
...
const peopleFilesTourStep = CoeloTourStep(
  ...
  text: 'Importe pessoas de uma planilha ou exporte em CSV ou XLSX.',
);
...
const peopleTabsTourStep = CoeloTourStep(
  ...
  title: 'Segmentos',
  text: 'Filtre por tipo de pessoa: responsáveis, equipe, alunos.',
);
...
const peopleCreateTourStep = CoeloTourStep(
  ...
  title: 'Criar pessoa',
  text: 'Abre o formulário de uma nova pessoa.',
);
...
const peopleBodyTourStep = CoeloTourStep(
  ...
  title: 'A lista',
  text: 'Abra uma pessoa para editar dados, vínculos e acesso.',
);
