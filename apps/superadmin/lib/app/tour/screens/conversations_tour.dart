...
const conversationsHeaderTourStep = CoeloTourStep(
  ...
  title: 'Conversas',
  text:
      'Comunicação institucional privada e contextual.',
);
...
const conversationsSearchTourStep = CoeloTourStep(
  ...
  text:
      'Encontre uma conversa pelo nome ou contexto.',
);
...
const conversationsCreateTourStep = CoeloTourStep(
  ...
  title: 'Criar grupo',
  text:
      'Abra um grupo com pessoas do seu escopo.',
);
...
const conversationsListTourStep = CoeloTourStep(
  ...
  title: 'Lista',
  text:
      'Cada conversa mostra tipo, contexto e não lidas. Clique para abrir.',
);
...
const conversationsThreadTourStep = CoeloTourStep(
  ...
  title: 'A conversa',
  text:
      'Mensagens, anexos e ações (editar, revogar). Role para carregar as anteriores.',
);
...
const conversationsComposerTourStep = CoeloTourStep(
  ...
  title: 'Escrever',
  text:
      'Digite a mensagem, anexe arquivos e envie.',
);
