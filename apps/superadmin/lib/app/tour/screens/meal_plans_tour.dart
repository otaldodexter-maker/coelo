...
const mealPlansHeaderTourStep = CoeloTourStep(
  ...
  title: 'Cardápios',
  text:
      'Modelos de cardápio e a publicação semanal para as famílias.',
);
...
const mealPlansLeadingTourStep = CoeloTourStep(
  ...
  text:
      '"Modelos" são a base; "Cardápios" são as publicações com abrangência e período.',
);
...
const mealPlansViewTourStep = CoeloTourStep(
  ...
  text:
      'A tabela mostra abrangência, período, origem e conflito.',
);
...
const mealPlansCreateTourStep = CoeloTourStep(
  ...
  text:
      'Abre o assistente de um novo cardápio ou modelo.',
);
...
const mealPlansBodyTourStep = CoeloTourStep(
  ...
  title: 'A lista',
  text:
      'Nas ações de cada item: Editar, Enviar revisão, Publicar, Arquivar ou Excluir.',
);
