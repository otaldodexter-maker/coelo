...
void main() {
  ...
  test('directory state contract is fail closed for non-data statuses', () async {
    ...
    expect(RoutineRepositoryFailureKind.values.map((kind) => kind.name), [
      'unauthorized',
      'notFound',
      'conflict',
      'unavailable',
    ...
    await expectLater(
      const UnavailableRoutineRepository().fetchPage(
