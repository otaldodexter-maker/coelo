...
void main() {
  ...
  test('failure and unauthorized never retain entries', () async {
    final failures = <Exception>[
      Exception('offline'),
      const RoutineRepositoryException(RoutineRepositoryFailureKind.unauthorized),
      const RoutineRepositoryException(RoutineRepositoryFailureKind.notFound),
      const RoutineRepositoryException(RoutineRepositoryFailureKind.conflict),
      const RoutineRepositoryException(RoutineRepositoryFailureKind.unavailable),
    ];
    final expected = [
